# DADHosp: HOSPITAL.COST regression:: DADHosp_SLR
bdanalytics  

**  **    
**Date: (Sun) Dec 06, 2015**    
...
![](DADHosp_SLR_files/figure-html/set_global_options-1.png) 
...
## 1 import.data          1          0           0 9.775  NA      NA
```
...
![](DADHosp_SLR_files/figure-html/import.data-1.png) 
...
```
##          label step_major step_minor label_minor    bgn   end elapsed
## 1  import.data          1          0           0  9.775 17.35   7.576
## 2 inspect.data          2          0           0 17.351    NA      NA
```
...
![](DADHosp_SLR_files/figure-html/inspect.data-1.png) 
...
![](DADHosp_SLR_files/figure-html/inspect.data-2.png) ![](DADHosp_SLR_files/figure-html/inspect.data-3.png) 

```
##          label step_major step_minor label_minor    bgn    end elapsed
## 2 inspect.data          2          0           0 17.351 21.611    4.26
## 3   scrub.data          2          1           1 21.611     NA      NA
```
...
```
##            label step_major step_minor label_minor    bgn   end elapsed
## 3     scrub.data          2          1           1 21.611 22.88   1.269
## 4 transform.data          2          2           2 22.881    NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn    end elapsed
## 4   transform.data          2          2           2 22.881 22.924   0.044
## 5 extract.features          3          0           0 22.925     NA      NA
```
...
## 1 extract.features_bgn          1          0           0 23.005  NA
##   elapsed
## 1      NA
```
...
## 2 23.015 23.036   0.021    0.021
## 1 23.005 23.015   0.010    0.010
## [1] "Total Elapsed Time: 23.036 secs"
```

![](DADHosp_SLR_files/figure-html/extract.features-1.png) 
...
![](DADHosp_SLR_files/figure-html/extract.features-2.png) 

```
##                 label step_major step_minor label_minor    bgn   end
## 5    extract.features          3          0           0 22.925 24.27
## 6 manage.missing.data          3          1           1 24.270    NA
##   elapsed
## 5   1.345
## 6      NA
```
...
```
##                 label step_major step_minor label_minor    bgn    end
## 6 manage.missing.data          3          1           1 24.270 24.692
## 7        cluster.data          3          2           2 24.693     NA
##   elapsed
## 6   0.423
## 7      NA
```
...
```
##                     label step_major step_minor label_minor    bgn    end
## 7            cluster.data          3          2           2 24.693 24.739
## 8 partition.data.training          4          0           0 24.740     NA
##   elapsed
## 7   0.046
## 8      NA
```
...
```
##                     label step_major step_minor label_minor    bgn    end
## 8 partition.data.training          4          0           0 24.740 24.833
## 9         select.features          5          0           0 24.833     NA
##   elapsed
## 8   0.093
## 9      NA
```
...
## PTID               PTID -0.498936977               0 0.498936977
## .rownames     .rownames -0.498936977               1 0.498936977
## BODY.WEIGHT BODY.WEIGHT  0.348358487               0 0.348358487
## .rnorm           .rnorm  0.008126187               0 0.008126187
```
...
## BODY.WEIGHT         NA  1.444444      29.43548   FALSE FALSE
## .rnorm              NA  1.000000     100.00000   FALSE FALSE
## .rownames           NA  1.000000     100.00000   FALSE FALSE
## PTID                NA  1.000000     100.00000   FALSE FALSE
##             is.cor.y.abs.low
## BODY.WEIGHT            FALSE
## .rnorm                 FALSE
## .rownames              FALSE
...
![](DADHosp_SLR_files/figure-html/select.features-1.png) 
...
![](DADHosp_SLR_files/figure-html/select.features-2.png) 
...
##               interaction.feat shapiro.test.p.value rsp_var_raw rsp_var
## HOSPITAL.COST               NA                   NA          NA    TRUE
```
...
```
##              label step_major step_minor label_minor    bgn    end elapsed
## 9  select.features          5          0           0 24.833 26.314   1.481
## 10      fit.models          6          0           0 26.314     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_0_bgn          1          0       setup 26.794  NA      NA
```
...
```
##              label step_major step_minor   label_minor    bgn    end
## 1 fit.models_0_bgn          1          0         setup 26.794 26.828
## 2 fit.models_0_MFO          1          1 myMFO_classfr 26.828     NA
##   elapsed
## 1   0.034
## 2      NA
```
...
![](DADHosp_SLR_files/figure-html/fit.models_0-1.png) ![](DADHosp_SLR_files/figure-html/fit.models_0-2.png) ![](DADHosp_SLR_files/figure-html/fit.models_0-3.png) ![](DADHosp_SLR_files/figure-html/fit.models_0-4.png) 
...
## -153657  -67699  -36116   20812  689661 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 198770.3     7808.6  25.455   <2e-16 ***
## .rnorm         986.7     7741.4   0.127    0.899    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 122800 on 246 degrees of freedom
## Multiple R-squared:  6.603e-05,	Adjusted R-squared:  -0.003999 
## F-statistic: 0.01625 on 1 and 246 DF,  p-value: 0.8987
## 
##         id  feats max.nTuningRuns min.elapsedtime.everything
## 1 MFO###lm .rnorm               0                      0.502
##   min.elapsedtime.final max.R.sq.fit min.RMSE.fit max.Adj.R.sq.fit
## 1                 0.003 6.603491e-05     122336.1     -0.003998737
##   max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1 0.0004125519     122314.9     -0.003650812
```
...
![](DADHosp_SLR_files/figure-html/fit.models_0-5.png) 
...
## (Intercept) BODY.WEIGHT        PTID 
## 243851.4960   1265.5009   -744.0191 
## [1] "max lambda < lambdaOpt:"
## (Intercept) BODY.WEIGHT        PTID 
## 243901.2170   1266.5451   -744.7333 
##                           id            feats max.nTuningRuns
## 1 Max.cor.Y.rcv.1X1###glmnet PTID,BODY.WEIGHT               0
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.678                  0.01    0.3034957
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1     102101.2        0.2978099    0.3034957     102101.2        0.2978099
```
...
![](DADHosp_SLR_files/figure-html/fit.models_0-6.png) ![](DADHosp_SLR_files/figure-html/fit.models_0-7.png) 
...
##   Primary splits:
##       PTID        < 37.5  to the right, improve=0.5794154, (0 missing)
...
##       PTID        < 129.5 to the right, improve=0.03594479, (0 missing)
##   Surrogate splits:
##       PTID < 57.5  to the right, agree=0.645, adj=0.176, (0 split)
## 
...
##   Primary splits:
##       PTID        < 15.5  to the right, improve=0.36808990, (0 missing)
...
##   2) PTID>=37.5 211 6.565292e+11 159727.0  
##     4) BODY.WEIGHT< 38.5 120 2.721887e+11 144201.3 *
##     5) BODY.WEIGHT>=38.5 91 3.172713e+11 180200.4 *
##   3) PTID< 37.5 37 9.046136e+11 421107.7  
##     6) PTID>=15.5 22 1.770885e+11 342775.2 *
##     7) PTID< 15.5 15 3.945460e+11 535995.3 *
##                     id            feats max.nTuningRuns
## 1 Max.cor.Y##rcv#rpart PTID,BODY.WEIGHT               5
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.423                 0.011    0.6871917
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1     74482.18               NA    0.6871917     68423.92               NA
...
## 3 fit.models_0_Max.cor.Y.rcv.*X*          1          2      glmnet 28.894
## 4         fit.models_0_Low.cor.X          1          3      glmnet 33.727
##      end elapsed
## 3 33.726   4.832
## 4     NA      NA
```
...
## [1] "    indep_vars: BODY.WEIGHT,.rnorm,PTID"
## Aggregating results
## Selecting tuning parameters
## Fitting alpha = 0.775, lambda = 5666 on full training set
```

![](DADHosp_SLR_files/figure-html/fit.models_0-8.png) ![](DADHosp_SLR_files/figure-html/fit.models_0-9.png) 
...
## [1] "min lambda > lambdaOpt:"
## (Intercept) BODY.WEIGHT        PTID 
## 243400.9140   1113.4744   -694.5645 
## [1] "max lambda < lambdaOpt:"
## (Intercept)      .rnorm BODY.WEIGHT        PTID 
## 243535.1790   -415.5830   1128.0192   -700.1871 
##                      id                   feats max.nTuningRuns
## 1 Low.cor.X##rcv#glmnet BODY.WEIGHT,.rnorm,PTID              25
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.684                 0.006    0.3011436
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1     103116.4        0.2925511    0.3010643     102279.2        0.2924709
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.2990602       12842.93          0.0442565
```
...
```
##                    label step_major step_minor label_minor    bgn    end
## 4 fit.models_0_Low.cor.X          1          3      glmnet 33.727 37.173
## 5       fit.models_0_end          1          4    teardown 37.173     NA
##   elapsed
## 4   3.446
## 5      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 10 fit.models          6          0           0 26.314 37.183  10.869
## 11 fit.models          6          1           1 37.183     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_1_bgn          1          0       setup 38.298  NA      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 1   fit.models_1_bgn          1          0       setup 38.298 38.308
## 2 fit.models_1_All.X          1          1       setup 38.309     NA
##   elapsed
## 1    0.01
## 2      NA
##                label step_major step_minor label_minor    bgn    end
## 2 fit.models_1_All.X          1          1       setup 38.309 38.315
## 3 fit.models_1_All.X          1          2      glmnet 38.315     NA
##   elapsed
## 2   0.006
## 3      NA
...
![](DADHosp_SLR_files/figure-html/fit.models_1-1.png) ![](DADHosp_SLR_files/figure-html/fit.models_1-2.png) 
...
## 243535.1790   -415.5830   1128.0192   -700.1871 
##                  id                   feats max.nTuningRuns
## 1 All.X##rcv#glmnet BODY.WEIGHT,.rnorm,PTID              25
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.726                 0.006    0.3011436
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1     103116.4        0.2925511    0.3010643     102279.2        0.2924709
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.2990602       12842.93          0.0442565
...
```
##                  label step_major step_minor label_minor    bgn    end
## 3   fit.models_1_All.X          1          2      glmnet 38.315 41.541
## 4 fit.models_1_preProc          1          3     preProc 41.541     NA
##   elapsed
## 3   3.226
## 4      NA
```
...
## MFO###lm                                    .rnorm               0
## Max.cor.Y.rcv.1X1###glmnet        PTID,BODY.WEIGHT               0
## Max.cor.Y##rcv#rpart              PTID,BODY.WEIGHT               5
## Low.cor.X##rcv#glmnet      BODY.WEIGHT,.rnorm,PTID              25
## All.X##rcv#glmnet          BODY.WEIGHT,.rnorm,PTID              25
##                            min.elapsedtime.everything
## MFO###lm                                        0.502
## Max.cor.Y.rcv.1X1###glmnet                      0.678
## Max.cor.Y##rcv#rpart                            1.423
## Low.cor.X##rcv#glmnet                           1.684
## All.X##rcv#glmnet                               1.726
##                            min.elapsedtime.final max.R.sq.fit min.RMSE.fit
## MFO###lm                                   0.003 6.603491e-05    122336.05
## Max.cor.Y.rcv.1X1###glmnet                 0.010 3.034957e-01    102101.17
## Max.cor.Y##rcv#rpart                       0.011 6.871917e-01     74482.18
## Low.cor.X##rcv#glmnet                      0.006 3.011436e-01    103116.45
## All.X##rcv#glmnet                          0.006 3.011436e-01    103116.45
##                            max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB
## MFO###lm                       -0.003998737 0.0004125519    122314.85
## Max.cor.Y.rcv.1X1###glmnet      0.297809904 0.3034956533    102101.17
## Max.cor.Y##rcv#rpart                     NA 0.6871917034     68423.92
## Low.cor.X##rcv#glmnet           0.292551096 0.3010643460    102279.22
## All.X##rcv#glmnet               0.292551096 0.3010643460    102279.22
##                            max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                       -0.003650812               NA
## Max.cor.Y.rcv.1X1###glmnet      0.297809904               NA
## Max.cor.Y##rcv#rpart                     NA        0.6438406
## Low.cor.X##rcv#glmnet           0.292470875        0.2990602
## All.X##rcv#glmnet               0.292470875        0.2990602
##                            min.RMSESD.fit max.RsquaredSD.fit
## MFO###lm                               NA                 NA
## Max.cor.Y.rcv.1X1###glmnet             NA                 NA
## Max.cor.Y##rcv#rpart             11491.25         0.07346218
## Low.cor.X##rcv#glmnet            12842.93         0.04425650
## All.X##rcv#glmnet                12842.93         0.04425650
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 4 fit.models_1_preProc          1          3     preProc 41.541 41.592
## 5     fit.models_1_end          1          4    teardown 41.592     NA
##   elapsed
## 4   0.051
## 5      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 11 fit.models          6          1           1 37.183 41.599   4.416
## 12 fit.models          6          2           2 41.600     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0       setup 42.509  NA      NA
```
...
## MFO###lm                   6.603491e-05     -0.003998737 0.0004125519
## Max.cor.Y.rcv.1X1###glmnet 3.034957e-01      0.297809904 0.3034956533
## Max.cor.Y##rcv#rpart       6.871917e-01               NA 0.6871917034
## Low.cor.X##rcv#glmnet      3.011436e-01      0.292551096 0.3010643460
## All.X##rcv#glmnet          3.011436e-01      0.292551096 0.3010643460
##                            max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                       -0.003650812               NA
## Max.cor.Y.rcv.1X1###glmnet      0.297809904               NA
## Max.cor.Y##rcv#rpart                     NA        0.6438406
...
## MFO###lm                                    1.9920319
## Max.cor.Y.rcv.1X1###glmnet                  1.4749263
## Max.cor.Y##rcv#rpart                        0.7027407
## Low.cor.X##rcv#glmnet                       0.5938242
## All.X##rcv#glmnet                           0.5793743
##                            inv.elapsedtime.final inv.RMSE.fit inv.RMSE.OOB
## MFO###lm                               333.33333 8.174205e-06 8.175622e-06
## Max.cor.Y.rcv.1X1###glmnet             100.00000 9.794207e-06 9.794207e-06
## Max.cor.Y##rcv#rpart                    90.90909 1.342603e-05 1.461477e-05
## Low.cor.X##rcv#glmnet                  166.66667 9.697774e-06 9.777157e-06
## All.X##rcv#glmnet                      166.66667 9.697774e-06 9.777157e-06
```
...
![](DADHosp_SLR_files/figure-html/fit.models_2-1.png) 
...
![](DADHosp_SLR_files/figure-html/fit.models_2-2.png) 
...
## 3       Max.cor.Y##rcv#rpart     68423.92 0.6871917034               NA
## 2 Max.cor.Y.rcv.1X1###glmnet    102101.17 0.3034956533      0.297809904
## 4      Low.cor.X##rcv#glmnet    102279.22 0.3010643460      0.292551096
## 5          All.X##rcv#glmnet    102279.22 0.3010643460      0.292551096
## 1                   MFO###lm    122314.85 0.0004125519     -0.003998737
##   min.RMSE.fit
## 3     74482.18
## 2    102101.17
## 4    103116.45
...
![](DADHosp_SLR_files/figure-html/fit.models_2-3.png) 
...
![](DADHosp_SLR_files/figure-html/fit.models_2-4.png) 
...
## .rnorm       31.53251              31.53251
## PTID          0.00000               0.00000
```
...
![](DADHosp_SLR_files/figure-html/fit.models_2-5.png) ![](DADHosp_SLR_files/figure-html/fit.models_2-6.png) ![](DADHosp_SLR_files/figure-html/fit.models_2-7.png) 

```
##     PTID BODY.WEIGHT HOSPITAL.COST .src .rownames     .rnorm
## 255    7          60        887350 Test       255  0.3543792
## 250    2          41        809130 Test       250  0.4382280
## 261   13          71        711616 Test       261 -0.9534625
## 249    1          49        660293 Test       249 -1.8093535
## 284   36           6        551809 Test       284  0.7351188
##     HOSPITAL.COST.All.X..rcv.glmnet HOSPITAL.COST.All.X..rcv.glmnet.err
## 255                        305592.6                            581757.4
## 250                        287824.8                            521305.2
## 261                        313873.7                            397742.3
## 249                        297742.8                            362550.2
## 284                        224991.8                            326817.2
...
![](DADHosp_SLR_files/figure-html/fit.models_2-8.png) 
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0    teardown 50.161  NA      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 12 fit.models          6          2           2 41.600 50.171   8.571
## 13 fit.models          6          3           3 50.172     NA      NA
```
...
![](DADHosp_SLR_files/figure-html/fit.models_3-1.png) 
...
```
##                label step_major step_minor label_minor    bgn    end
## 13        fit.models          6          3           3 50.172 54.711
## 14 fit.data.training          7          0           0 54.712     NA
##    elapsed
## 13    4.54
## 14      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 14 fit.data.training          7          0           0 54.712 55.139
## 15 fit.data.training          7          1           1 55.139     NA
##    elapsed
## 14   0.427
## 15      NA
```
...
## .rnorm                   31.53251  31.53251                    31.53251
## PTID                      0.00000   0.00000                     0.00000
```
...
![](DADHosp_SLR_files/figure-html/fit.data.training_1-1.png) ![](DADHosp_SLR_files/figure-html/fit.data.training_1-2.png) ![](DADHosp_SLR_files/figure-html/fit.data.training_1-3.png) 

```
##    PTID BODY.WEIGHT HOSPITAL.COST  .src .rownames     .rnorm .lcn
## 7     7          60        887350 Train         7 -1.0953663  Fit
## 2     2          41        809130 Train         2  1.4350423  Fit
## 13   13          71        711616 Train        13 -0.4824486  Fit
## 1     1          49        660293 Train         1 -0.4801124  Fit
## 36   36           6        551809 Train        36 -0.9143084  Fit
##    HOSPITAL.COST.All.X..rcv.glmnet HOSPITAL.COST.All.X..rcv.glmnet.err
## 7                         305772.7                           -581577.3
## 2                         287701.0                           -521429.0
## 13                        313815.2                           -397800.8
## 1                         297577.7                           -362715.3
## 36                        225196.7                           -326612.3
##    HOSPITAL.COST.All.X..rcv.glmnet.err.abs
## 7                                 581577.3
## 2                                 521429.0
## 13                                397800.8
...
![](DADHosp_SLR_files/figure-html/fit.data.training_1-4.png) 
...
![](DADHosp_SLR_files/figure-html/fit.data.training_1-5.png) 
...
```
##                label step_major step_minor label_minor    bgn    end
## 15 fit.data.training          7          1           1 55.139 58.605
## 16  predict.data.new          8          0           0 58.606     NA
##    elapsed
## 15   3.466
## 16      NA
```
...
![](DADHosp_SLR_files/figure-html/predict.data.new-1.png) ![](DADHosp_SLR_files/figure-html/predict.data.new-2.png) ![](DADHosp_SLR_files/figure-html/predict.data.new-3.png) 

```
##     PTID BODY.WEIGHT HOSPITAL.COST .src .rownames     .rnorm .lcn
## 255    7          60        887350 Test       255  0.3543792  OOB
## 250    2          41        809130 Test       250  0.4382280  OOB
## 261   13          71        711616 Test       261 -0.9534625  OOB
## 249    1          49        660293 Test       249 -1.8093535  OOB
## 284   36           6        551809 Test       284  0.7351188  OOB
##     HOSPITAL.COST.Final.All.X..rcv.glmnet
## 255                              305592.6
## 250                              287824.8
## 261                              313873.7
...
![](DADHosp_SLR_files/figure-html/predict.data.new-4.png) 
...
```
##   min.RMSE.OOB max.R.sq.OOB max.Adj.R.sq.fit min.RMSE.fit
## 3     68423.92 0.6871917034               NA     74482.18
## 2    102101.17 0.3034956533      0.297809904    102101.17
## 4    102279.22 0.3010643460      0.292551096    103116.45
## 5    102279.22 0.3010643460      0.292551096    103116.45
## 1    122314.85 0.0004125519     -0.003998737    122336.05
```

```
## [1] "All.X##rcv#glmnet OOB RMSE: 102279.2176"
## [1] "Final.All.X##rcv#glmnet prediction stats for glbObsNew:"
##                  id max.R.sq.new min.RMSE.new max.Adj.R.sq.new
## 1 All.X##rcv#glmnet    0.3010643     102279.2        0.2924709
```
...
![](DADHosp_SLR_files/figure-html/predict.data.new-5.png) 

```
##                   label step_major step_minor label_minor    bgn  end
## 16     predict.data.new          8          0           0 58.606 67.6
## 17 display.session.info          9          0           0 67.600   NA
##    elapsed
## 16   8.994
## 17      NA
```
...
```
##                      label step_major step_minor label_minor    bgn    end
## 10              fit.models          6          0           0 26.314 37.183
## 16        predict.data.new          8          0           0 58.606 67.600
## 12              fit.models          6          2           2 41.600 50.171
## 1              import.data          1          0           0  9.775 17.350
## 13              fit.models          6          3           3 50.172 54.711
## 11              fit.models          6          1           1 37.183 41.599
## 2             inspect.data          2          0           0 17.351 21.611
## 15       fit.data.training          7          1           1 55.139 58.605
## 9          select.features          5          0           0 24.833 26.314
## 5         extract.features          3          0           0 22.925 24.270
## 3               scrub.data          2          1           1 21.611 22.880
## 14       fit.data.training          7          0           0 54.712 55.139
## 6      manage.missing.data          3          1           1 24.270 24.692
## 8  partition.data.training          4          0           0 24.740 24.833
## 7             cluster.data          3          2           2 24.693 24.739
## 4           transform.data          2          2           2 22.881 22.924
##    elapsed duration
## 10  10.869   10.869
## 16   8.994    8.994
## 12   8.571    8.571
...
## 7    0.046    0.046
## 4    0.044    0.043
## [1] "Total Elapsed Time: 67.6 secs"
```

![](DADHosp_SLR_files/figure-html/display.session.info-1.png) 
...
##      bgn    end elapsed duration
## 3 28.894 33.726   4.832    4.832
## 4 33.727 37.173   3.446    3.446
## 2 26.828 28.893   2.065    2.065
## 1 26.794 26.828   0.034    0.034
## [1] "Total Elapsed Time: 37.173 secs"
```

![](DADHosp_SLR_files/figure-html/display.session.info-2.png) 
