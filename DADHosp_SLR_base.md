# DADHosp: HOSPITAL.COST regression:: DADHosp_SLR_base
bdanalytics  
...
![](DADHosp_SLR_base_files/figure-html/set_global_options-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/import.data-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/inspect.data-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/inspect.data-2.png) ![](DADHosp_SLR_base_files/figure-html/inspect.data-3.png) 
...
![](DADHosp_SLR_base_files/figure-html/extract.features-2.png) 
...
![](DADHosp_SLR_base_files/figure-html/select.features-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/select.features-2.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.models_0-1.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_0-2.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_0-3.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_0-4.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.models_0-5.png) 
...
## Fitting cp = 0.00473 on full training set
```
...
![](DADHosp_SLR_base_files/figure-html/fit.models_0-6.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_0-7.png) 
...
## 3 0.013675246      2 0.3308773
## 4 0.005312514      6 0.2724106
...
## 
## Node number 4: 119 observations,    complexity param=0.01367525
...
## 
## Node number 5: 92 observations,    complexity param=0.01367525
...
##   mean=113848, MSE=1.000383e+09 
## 
## Node number 9: 88 observations,    complexity param=0.005312514
...
##   mean=142416.7, MSE=8.444646e+08 
## 
## Node number 11: 48 observations,    complexity param=0.01367525
...
##   mean=183473.4, MSE=2.175466e+09 
## 
## Node number 23: 7 observations
##   mean=287527.6, MSE=2.057472e+09 
## 
## Node number 36: 70 observations
##   mean=152598.4, MSE=2.293845e+09 
## 
## Node number 37: 7 observations
##   mean=208470.9, MSE=4.173685e+09 
## 
## n= 248 
## 
...
## 1        0.6537292       11697.25         0.06529008
```
...
![](DADHosp_SLR_base_files/figure-html/fit.models_0-8.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_0-9.png) 

```
##             Length Class      Mode     
## a0           58    -none-     numeric  
## beta        116    dgCMatrix  S4       
## df           58    -none-     numeric  
## dim           2    -none-     numeric  
...
![](DADHosp_SLR_base_files/figure-html/fit.models_1-1.png) ![](DADHosp_SLR_base_files/figure-html/fit.models_1-2.png) 
...
## Max.cor.Y##rcv#rpart                     NA  0.702756152     66699.91
## Low.cor.X##rcv#glmnet          0.2406441937  0.246782831    106176.62
## All.X##rcv#glmnet              0.2406441937  0.246782831    106176.62
##                            max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                         -0.0115966               NA
## Max.cor.Y.rcv.1X1###glmnet        0.2411034               NA
## Max.cor.Y##rcv#rpart                     NA        0.6537292
## Low.cor.X##rcv#glmnet             0.2406341        0.2517975
## All.X##rcv#glmnet                 0.2406341        0.2517975
##                            min.RMSESD.fit max.RsquaredSD.fit
## MFO###lm                               NA                 NA
## Max.cor.Y.rcv.1X1###glmnet             NA                 NA
## Max.cor.Y##rcv#rpart             11697.25         0.06529008
## Low.cor.X##rcv#glmnet            11831.04         0.02755772
## All.X##rcv#glmnet                11831.04         0.02755772
```
...
## Max.cor.Y##rcv#rpart                     5  0.738214419               NA
## Low.cor.X##rcv#glmnet                   25  0.246792824     0.2406441937
## All.X##rcv#glmnet                       25  0.246792824     0.2406441937
##                            max.R.sq.OOB max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                   -0.007501072       -0.0115966               NA
## Max.cor.Y.rcv.1X1###glmnet  0.247248356        0.2411034               NA
## Max.cor.Y##rcv#rpart        0.702756152               NA        0.6537292
...
![](DADHosp_SLR_base_files/figure-html/fit.models_2-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.models_2-2.png) 
...
## 3       Max.cor.Y##rcv#rpart     66699.91  0.702756152               NA
## 2 Max.cor.Y.rcv.1X1###glmnet    106143.81  0.247248356     0.2438159028
## 4      Low.cor.X##rcv#glmnet    106176.62  0.246782831     0.2406441937
## 5          All.X##rcv#glmnet    106176.62  0.246782831     0.2406441937
...
![](DADHosp_SLR_base_files/figure-html/fit.models_2-3.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.models_2-4.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.models_2-7.png) 
...
## (3e+05,9e+05]      0.1370968      0.1370968         5837873
## [0,1e+05]          0.0766129      0.0766129         1654673
## (2e+05,3e+05]      0.1774194      0.1774194         2824991
## (1e+05,2e+05]      0.6088710      0.6088710         8913461
##               err.abs.fit.mean .n.fit err.abs.OOB.sum err.abs.OOB.mean
## (3e+05,9e+05]        171702.16     34         5851023        172088.90
## [0,1e+05]             87088.05     19         1647325         86701.31
## (2e+05,3e+05]         64204.34     44         2835046         64432.86
## (1e+05,2e+05]         59029.54    151         8886776         58852.82
##           .n.OOB           .n.Fit           .n.Tst   .freqRatio.Fit 
##            248.0            248.0            248.0              1.0 
##   .freqRatio.OOB   .freqRatio.Tst  err.abs.fit.sum err.abs.fit.mean 
##              1.0              1.0       19230997.8         382024.1 
##           .n.fit  err.abs.OOB.sum err.abs.OOB.mean 
##            248.0       19220169.2         382075.9
```
...
![](DADHosp_SLR_base_files/figure-html/fit.models_3-1.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.data.training_1-3.png) 
...
![](DADHosp_SLR_base_files/figure-html/fit.data.training_1-4.png) 
...
![](DADHosp_SLR_base_files/figure-html/predict.data.new-3.png) 
...
## (3e+05,9e+05]     34     34     34     34        172088.90
## [0,1e+05]         19     19     19     19         86701.31
## (2e+05,3e+05]     44     44     44     44         64432.86
## (1e+05,2e+05]    151    151    151    151         58852.82
##               err.abs.fit.mean err.abs.new.mean err.abs.trn.mean
## (3e+05,9e+05]        171702.16        172088.90        171702.16
## [0,1e+05]             87088.05         86701.31         87088.05
## (2e+05,3e+05]         64204.34         64432.86         64204.34
## (1e+05,2e+05]         59029.54         58852.82         59029.54
##               err.abs.OOB.sum err.abs.fit.sum err.abs.new.sum
## (3e+05,9e+05]         5851023         5837873         5851023
## [0,1e+05]             1647325         1654673         1647325
## (2e+05,3e+05]         2835046         2824991         2835046
## (1e+05,2e+05]         8886776         8913461         8886776
##               err.abs.trn.sum
## (3e+05,9e+05]         5837873
## [0,1e+05]             1654673
## (2e+05,3e+05]         2824991
...
##            248.0         382075.9         382024.1         382075.9 
