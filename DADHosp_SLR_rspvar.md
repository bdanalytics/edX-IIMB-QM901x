# DADHosp: HOSPITAL.COST regression:: DADHosp_SLR_rspvar
bdanalytics  
...
glb_rsp_var <- "Hosp.Cost.log" # or "HOSPITAL.COST.fctr"
...
glb_sel_mdl_id <- "All.X##rcv#glm" #select from c(NULL, "All.X##rcv#glmnet", "RFE.X##rcv#glmnet", <mdlId>)
...
glb_out_pfx <- "DADHosp_SLR_rspvar_"
...
![](DADHosp_SLR_rspvar_files/figure-html/set_global_options-1.png) 
...
## 1 import.data          1          0           0 9.238  NA      NA
```
...
![](DADHosp_SLR_rspvar_files/figure-html/import.data-1.png) 
...
```
##          label step_major step_minor label_minor    bgn    end elapsed
## 1  import.data          1          0           0  9.238 13.585   4.347
## 2 inspect.data          2          0           0 13.586     NA      NA
```
...
![](DADHosp_SLR_rspvar_files/figure-html/inspect.data-1.png) 
...
```
##   HOSPITAL.COST Hosp.Cost.log .n
## 1      109085.8      11.59989  4
## 2      114580.0      11.64903  4
## 3      119935.4      11.69471  4
## 4      120064.0      11.69578  4
## 5      122892.0      11.71906  4
## 6      125643.0      11.74120  4
##     HOSPITAL.COST Hosp.Cost.log .n
## 54         129684      11.77286  2
## 94         146355      11.89379  2
## 114        162271      11.99702  2
## 129        169641      12.04144  2
## 167        205998      12.23562  2
## 186        241130      12.39309  2
##     HOSPITAL.COST Hosp.Cost.log .n
## 234        551809      13.22096  2
## 235        629990      13.35346  2
## 236        660293      13.40044  2
## 237        711616      13.47529  2
## 238        809130      13.60371  2
## 239        887350      13.69599  2
```

![](DADHosp_SLR_rspvar_files/figure-html/inspect.data-2.png) 

```
## `stat_bin()` using `bins = 30`. Pick better value with `binwidth`.
```

![](DADHosp_SLR_rspvar_files/figure-html/inspect.data-3.png) ![](DADHosp_SLR_rspvar_files/figure-html/inspect.data-4.png) 

```
##          label step_major step_minor label_minor    bgn    end elapsed
## 2 inspect.data          2          0           0 13.586 21.195   7.609
## 3   scrub.data          2          1           1 21.196     NA      NA
```
...
```
##            label step_major step_minor label_minor    bgn    end elapsed
## 3     scrub.data          2          1           1 21.196 24.099   2.903
## 4 transform.data          2          2           2 24.099     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn    end elapsed
## 4   transform.data          2          2           2 24.099 24.145   0.046
## 5 extract.features          3          0           0 24.145     NA      NA
```
...
```
##                  label step_major step_minor label_minor  bgn end elapsed
## 1 extract.features_bgn          1          0           0 24.2  NA      NA
```
...
## 2 24.21 24.23   0.021     0.02
## 1 24.20 24.21   0.010     0.01
## [1] "Total Elapsed Time: 24.23 secs"
```

![](DADHosp_SLR_rspvar_files/figure-html/extract.features-1.png) 
...
![](DADHosp_SLR_rspvar_files/figure-html/extract.features-2.png) 

```
##                 label step_major step_minor label_minor    bgn    end
## 5    extract.features          3          0           0 24.145 25.468
## 6 manage.missing.data          3          1           1 25.469     NA
##   elapsed
## 5   1.323
## 6      NA
```
...
```
##                 label step_major step_minor label_minor    bgn    end
## 6 manage.missing.data          3          1           1 25.469 25.909
## 7        cluster.data          3          2           2 25.910     NA
##   elapsed
## 6   0.441
## 7      NA
```
...
```
##                     label step_major step_minor label_minor    bgn    end
## 7            cluster.data          3          2           2 25.910 25.952
## 8 partition.data.training          4          0           0 25.952     NA
##   elapsed
## 7   0.042
## 8      NA
```
...
```
## [1] "Newdata contains non-NA data for Hosp.Cost.log; setting OOB to Newdata"
```
...
```
##                     label step_major step_minor label_minor    bgn    end
## 8 partition.data.training          4          0           0 25.952 26.095
## 9         select.features          5          0           0 26.096     NA
##   elapsed
## 8   0.144
## 9      NA
```
...
## HospCost.cut.fctr HospCost.cut.fctr  0.92488332               1 0.92488332
## HOSPITAL.COST         HOSPITAL.COST  0.92424274               1 0.92424274
## PTID                           PTID -0.47202794               1 0.47202794
## BODY.WEIGHT             BODY.WEIGHT  0.38624773               0 0.38624773
## .rnorm                       .rnorm  0.07613297               0 0.07613297
```
...
## HOSPITAL.COST             NA  1.000000     96.370968   FALSE FALSE
...
![](DADHosp_SLR_rspvar_files/figure-html/select.features-1.png) 
...
![](DADHosp_SLR_rspvar_files/figure-html/select.features-2.png) 
...
## Hosp.Cost.log Hosp.Cost.log            TRUE    TRUE
```

```
##                          id      cor.y exclude.as.feat cor.y.abs
## HOSPITAL.COST HOSPITAL.COST  0.9242427            TRUE 0.9242427
## PTID                   PTID -0.4720279            TRUE 0.4720279
## Hosp.Cost.log Hosp.Cost.log         NA            TRUE        NA
##               cor.high.X freqRatio percentUnique zeroVar   nzv
## HOSPITAL.COST         NA         1      96.37097   FALSE FALSE
## PTID                  NA         1     100.00000   FALSE FALSE
## Hosp.Cost.log         NA        NA            NA      NA    NA
##               is.cor.y.abs.low interaction.feat shapiro.test.p.value
## HOSPITAL.COST            FALSE               NA                   NA
## PTID                     FALSE               NA                   NA
## Hosp.Cost.log               NA               NA                   NA
##               rsp_var_raw id_var rsp_var
## HOSPITAL.COST        TRUE     NA      NA
## PTID                FALSE   TRUE      NA
## Hosp.Cost.log          NA     NA    TRUE
```
...
```
##              label step_major step_minor label_minor    bgn    end elapsed
## 9  select.features          5          0           0 26.096 27.583   1.487
## 10      fit.models          6          0           0 27.583     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_0_bgn          1          0       setup 28.047  NA      NA
```
...
```
##              label step_major step_minor   label_minor    bgn   end
## 1 fit.models_0_bgn          1          0         setup 28.047 28.08
## 2 fit.models_0_MFO          1          1 myMFO_classfr 28.080    NA
##   elapsed
## 1   0.033
## 2      NA
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-1.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-2.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-3.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-4.png) 
...
## -1.29869 -0.28304 -0.05497  0.25958  1.65039 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 12.06395    0.03210 375.801   <2e-16 ***
## .rnorm       0.03803    0.03176   1.198    0.232    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.5049 on 246 degrees of freedom
## Multiple R-squared:  0.005796,	Adjusted R-squared:  0.001755 
## F-statistic: 1.434 on 1 and 246 DF,  p-value: 0.2322
## 
##         id  feats max.nTuningRuns min.elapsedtime.everything
## 1 MFO###lm .rnorm               0                       0.52
##   min.elapsedtime.final max.R.sq.fit min.RMSE.fit max.Adj.R.sq.fit
## 1                 0.004  0.005796229    0.5029066       0.00175475
##   max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1  -0.01193403    0.5073711      -0.01604758
```
...
## [1] "    indep_vars: BODY.WEIGHT,.rnorm"
```
...
```
## Fitting alpha = 0.1, lambda = 0.0039 on full training set
```

![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-5.png) 

```
##             Length Class      Mode     
## a0           71    -none-     numeric  
## beta        142    dgCMatrix  S4       
## df           71    -none-     numeric  
## dim           2    -none-     numeric  
...
##  (Intercept)       .rnorm  BODY.WEIGHT 
## 11.751975701  0.026888035  0.008296706 
## [1] "max lambda < lambdaOpt:"
##  (Intercept)       .rnorm  BODY.WEIGHT 
## 11.751716036  0.026933689  0.008303683 
##                           id              feats max.nTuningRuns
## 1 Max.cor.Y.rcv.1X1###glmnet BODY.WEIGHT,.rnorm               0
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.651                 0.009    0.1521751
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1    0.4644112        0.1452541    0.1446392    0.4664706        0.1376567
```
...
## Fitting cp = 0.0246 on full training set
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-6.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-7.png) 
...
## 
##           CP nsplit rel error
## 1 0.18987739      0 1.0000000
## 2 0.02464631      1 0.8101226
## 
## Variable importance
## BODY.WEIGHT      .rnorm 
##          90          10 
## 
## Node number 1: 248 observations,    complexity param=0.1898774
##   mean=12.06208, MSE=0.2543896 
##   left son=2 (122 obs) right son=3 (126 obs)
##   Primary splits:
##       BODY.WEIGHT < 38.5       to the left,  improve=0.18987740, (0 missing)
##       .rnorm      < 0.5703666  to the left,  improve=0.02043166, (0 missing)
##   Surrogate splits:
##       .rnorm < -0.5070017 to the left,  agree=0.565, adj=0.115, (0 split)
## 
## Node number 2: 122 observations
##   mean=11.83873, MSE=0.1522431 
## 
## Node number 3: 126 observations
##   mean=12.27835, MSE=0.2582211 
## 
## n= 248 
## 
...
## 
## 1) root 248 63.08861 12.06208  
##   2) BODY.WEIGHT< 38.5 122 18.57365 11.83873 *
##   3) BODY.WEIGHT>=38.5 126 32.53585 12.27835 *
##                     id              feats max.nTuningRuns
## 1 Max.cor.Y##rcv#rpart BODY.WEIGHT,.rnorm               5
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.303                  0.01    0.1898774
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1    0.4797535               NA    0.1898774    0.4539678               NA
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.1320893     0.04290367          0.0492474
```
...
## 3 fit.models_0_Max.cor.Y.rcv.*X*          1          2      glmnet 29.988
## 4         fit.models_0_Low.cor.X          1          3      glmnet 34.703
##      end elapsed
## 3 34.703   4.715
## 4     NA      NA
```
...
## Aggregating results
## Selecting tuning parameters
## Fitting alpha = 0.325, lambda = 0.0181 on full training set
```

![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-8.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_0-9.png) 
...
## [1] "min lambda > lambdaOpt:"
##  (Intercept)       .rnorm  BODY.WEIGHT 
## 11.765938081  0.021267675  0.007917391 
## [1] "max lambda < lambdaOpt:"
##  (Intercept)       .rnorm  BODY.WEIGHT 
## 11.764469647  0.021801540  0.007957209 
##                      id              feats max.nTuningRuns
## 1 Low.cor.X##rcv#glmnet BODY.WEIGHT,.rnorm              25
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.585                 0.005    0.1516354
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1    0.4676364          0.14471    0.1454083    0.4662609         0.138432
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.1496268     0.03517891         0.05327291
```
...
```
##                    label step_major step_minor label_minor    bgn    end
## 4 fit.models_0_Low.cor.X          1          3      glmnet 34.703 37.776
## 5       fit.models_0_end          1          4    teardown 37.776     NA
##   elapsed
## 4   3.073
## 5      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 10 fit.models          6          0           0 27.583 37.786  10.203
## 11 fit.models          6          1           1 37.786     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_1_bgn          1          0       setup 38.939  NA      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 1   fit.models_1_bgn          1          0       setup 38.939 38.949
## 2 fit.models_1_All.X          1          1       setup 38.950     NA
##   elapsed
## 1   0.011
## 2      NA
##                label step_major step_minor label_minor    bgn    end
## 2 fit.models_1_All.X          1          1       setup 38.950 38.956
## 3 fit.models_1_All.X          1          2      glmnet 38.957     NA
##   elapsed
## 2   0.006
## 3      NA
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-1.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-2.png) 
...
## 11.764469647  0.021801540  0.007957209 
##                  id              feats max.nTuningRuns
## 1 All.X##rcv#glmnet BODY.WEIGHT,.rnorm              25
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.583                 0.006    0.1516354
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1    0.4676364          0.14471    0.1454083    0.4662609         0.138432
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.1496268     0.03517891         0.05327291
##                label step_major step_minor label_minor    bgn    end
## 3 fit.models_1_All.X          1          2      glmnet 38.957 41.997
## 4 fit.models_1_All.X          1          3         glm 41.997     NA
##   elapsed
## 3    3.04
## 4      NA
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-3.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-4.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-5.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_1-6.png) 
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -1.32177  -0.27161  -0.03125   0.25875   1.45764  
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 11.749033   0.056804 206.836  < 2e-16 ***
## .rnorm       0.027405   0.029431   0.931    0.353    
## BODY.WEIGHT  0.008376   0.001288   6.504 4.36e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 0.2183155)
## 
##     Null deviance: 63.089  on 247  degrees of freedom
## Residual deviance: 53.487  on 245  degrees of freedom
## AIC: 331.37
## 
## Number of Fisher Scoring iterations: 2
## 
##               id              feats max.nTuningRuns
## 1 All.X##rcv#glm BODY.WEIGHT,.rnorm               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.253                 0.006    0.1521877
##   min.RMSE.fit min.aic.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB
## 1    0.4678318    331.3654        0.1452668    0.1445632    0.4664914
##   max.Adj.R.sq.OOB max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1          0.13758        0.1488841     0.03497147          0.0524003
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 4   fit.models_1_All.X          1          3         glm 41.997 44.665
## 5 fit.models_1_preProc          1          4     preProc 44.665     NA
##   elapsed
## 4   2.668
## 5      NA
```
...
##                                                    id              feats
## MFO###lm                                     MFO###lm             .rnorm
## Max.cor.Y.rcv.1X1###glmnet Max.cor.Y.rcv.1X1###glmnet BODY.WEIGHT,.rnorm
## Max.cor.Y##rcv#rpart             Max.cor.Y##rcv#rpart BODY.WEIGHT,.rnorm
## Low.cor.X##rcv#glmnet           Low.cor.X##rcv#glmnet BODY.WEIGHT,.rnorm
## All.X##rcv#glmnet                   All.X##rcv#glmnet BODY.WEIGHT,.rnorm
## All.X##rcv#glm                         All.X##rcv#glm BODY.WEIGHT,.rnorm
##                            max.nTuningRuns min.elapsedtime.everything
## MFO###lm                                 0                      0.520
## Max.cor.Y.rcv.1X1###glmnet               0                      0.651
## Max.cor.Y##rcv#rpart                     5                      1.303
## Low.cor.X##rcv#glmnet                   25                      1.585
## All.X##rcv#glmnet                       25                      1.583
## All.X##rcv#glm                           1                      1.253
##                            min.elapsedtime.final max.R.sq.fit min.RMSE.fit
## MFO###lm                                   0.004  0.005796229    0.5029066
## Max.cor.Y.rcv.1X1###glmnet                 0.009  0.152175120    0.4644112
## Max.cor.Y##rcv#rpart                       0.010  0.189877395    0.4797535
## Low.cor.X##rcv#glmnet                      0.005  0.151635435    0.4676364
## All.X##rcv#glmnet                          0.006  0.151635435    0.4676364
## All.X##rcv#glm                             0.006  0.152187690    0.4678318
##                            max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB
## MFO###lm                         0.00175475  -0.01193403    0.5073711
## Max.cor.Y.rcv.1X1###glmnet       0.14525410   0.14463921    0.4664706
## Max.cor.Y##rcv#rpart                     NA   0.18987739    0.4539678
## Low.cor.X##rcv#glmnet            0.14471001   0.14540829    0.4662609
## All.X##rcv#glmnet                0.14471001   0.14540829    0.4662609
## All.X##rcv#glm                   0.14526677   0.14456320    0.4664914
##                            max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                        -0.01604758               NA
## Max.cor.Y.rcv.1X1###glmnet       0.13765667               NA
## Max.cor.Y##rcv#rpart                     NA        0.1320893
## Low.cor.X##rcv#glmnet            0.13843203        0.1496268
## All.X##rcv#glmnet                0.13843203        0.1496268
## All.X##rcv#glm                   0.13758004        0.1488841
##                            min.RMSESD.fit max.RsquaredSD.fit min.aic.fit
## MFO###lm                               NA                 NA          NA
## Max.cor.Y.rcv.1X1###glmnet             NA                 NA          NA
## Max.cor.Y##rcv#rpart           0.04290367         0.04924740          NA
## Low.cor.X##rcv#glmnet          0.03517891         0.05327291          NA
## All.X##rcv#glmnet              0.03517891         0.05327291          NA
## All.X##rcv#glm                 0.03497147         0.05240030    331.3654
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 5 fit.models_1_preProc          1          4     preProc 44.665 44.714
## 6     fit.models_1_end          1          5    teardown 44.715     NA
##   elapsed
## 5    0.05
## 6      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 11 fit.models          6          1           1 37.786 44.722   6.936
## 12 fit.models          6          2           2 44.722     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0       setup 46.159  NA      NA
```
...
## MFO###lm                                 0  0.005796229       0.00175475
## Max.cor.Y.rcv.1X1###glmnet               0  0.152175120       0.14525410
## Max.cor.Y##rcv#rpart                     5  0.189877395               NA
## Low.cor.X##rcv#glmnet                   25  0.151635435       0.14471001
## All.X##rcv#glmnet                       25  0.151635435       0.14471001
## All.X##rcv#glm                           1  0.152187690       0.14526677
##                            max.R.sq.OOB max.Adj.R.sq.OOB max.Rsquared.fit
## MFO###lm                    -0.01193403      -0.01604758               NA
## Max.cor.Y.rcv.1X1###glmnet   0.14463921       0.13765667               NA
## Max.cor.Y##rcv#rpart         0.18987739               NA        0.1320893
## Low.cor.X##rcv#glmnet        0.14540829       0.13843203        0.1496268
## All.X##rcv#glmnet            0.14540829       0.13843203        0.1496268
## All.X##rcv#glm               0.14456320       0.13758004        0.1488841
##                            inv.elapsedtime.everything
## MFO###lm                                    1.9230769
## Max.cor.Y.rcv.1X1###glmnet                  1.5360983
## Max.cor.Y##rcv#rpart                        0.7674597
## Low.cor.X##rcv#glmnet                       0.6309148
## All.X##rcv#glmnet                           0.6317119
## All.X##rcv#glm                              0.7980846
##                            inv.elapsedtime.final inv.RMSE.fit inv.RMSE.OOB
## MFO###lm                                250.0000     1.988441     1.970944
## Max.cor.Y.rcv.1X1###glmnet              111.1111     2.153264     2.143758
## Max.cor.Y##rcv#rpart                    100.0000     2.084404     2.202800
## Low.cor.X##rcv#glmnet                   200.0000     2.138414     2.144722
## All.X##rcv#glmnet                       166.6667     2.138414     2.144722
## All.X##rcv#glm                          166.6667     2.137521     2.143662
##                            inv.aic.fit
## MFO###lm                            NA
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-1.png) 
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-2.png) 
...
## 3       Max.cor.Y##rcv#rpart    0.4539678   0.18987739               NA
## 4      Low.cor.X##rcv#glmnet    0.4662609   0.14540829       0.14471001
## 5          All.X##rcv#glmnet    0.4662609   0.14540829       0.14471001
## 2 Max.cor.Y.rcv.1X1###glmnet    0.4664706   0.14463921       0.14525410
## 6             All.X##rcv#glm    0.4664914   0.14456320       0.14526677
## 1                   MFO###lm    0.5073711  -0.01193403       0.00175475
##   min.RMSE.fit
## 3    0.4797535
## 4    0.4676364
## 5    0.4676364
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-3.png) 
...
```
## [1] "User specified selection: All.X##rcv#glm"
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-4.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-5.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-6.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-7.png) 
...
```
## [1] "All.X##rcv#glm fit prediction diagnostics:"
```
...
```
## [1] "All.X##rcv#glm OOB prediction diagnostics:"
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-8.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-9.png) 

```
##     PTID BODY.WEIGHT HOSPITAL.COST .src Hosp.Cost.log     .rnorm
## 4      2          41      809130.0 Test      13.60371  0.9272271
## 14     7          60      887350.0 Test      13.69599 -1.2300370
## 72    36           6      551809.0 Test      13.22096 -0.1374965
## 318  159          64       55885.7 Test      10.93106 -0.4055507
## 2      1          49      660293.0 Test      13.40044  1.4350423
##     HospCost.cut.fctr Hosp.Cost.log.All.X..rcv.glm
## 4       (3e+05,9e+05]                     12.11785
## 14      (3e+05,9e+05]                     12.21787
## 72      (3e+05,9e+05]                     11.79552
## 318         [0,1e+05]                     12.27397
## 2       (3e+05,9e+05]                     12.19877
##     Hosp.Cost.log.All.X..rcv.glm.err Hosp.Cost.log.All.X..rcv.glm.err.abs
## 4                           1.485865                             1.485865
## 14                          1.478124                             1.478124
## 72                          1.425438                             1.425438
## 318                         1.342905                             1.342905
## 2                           1.201666                             1.201666
##     Hosp.Cost.log.All.X..rcv.glm.is.acc .label
## 4                                 FALSE      2
## 14                                FALSE      7
## 72                                FALSE     36
## 318                               FALSE    159
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_2-10.png) 
...
## [0,1e+05]          0.0766129      0.0766129        16.00789
## (3e+05,9e+05]      0.1370968      0.1370968        26.20177
## (2e+05,3e+05]      0.1774194      0.1774194        11.85833
## (1e+05,2e+05]      0.6088710      0.6088710        33.14288
##               err.abs.fit.mean .n.fit err.abs.OOB.sum err.abs.OOB.mean
## [0,1e+05]            0.8425207     19        16.09076        0.8468821
## (3e+05,9e+05]        0.7706404     34        26.34033        0.7747157
## (2e+05,3e+05]        0.2695075     44        11.99444        0.2726009
## (1e+05,2e+05]        0.2194893    151        33.26846        0.2203209
##           .n.OOB           .n.Fit           .n.Tst   .freqRatio.Fit 
##       248.000000       248.000000       248.000000         1.000000 
##   .freqRatio.OOB   .freqRatio.Tst  err.abs.fit.sum err.abs.fit.mean 
##         1.000000         1.000000        87.210877         2.102158 
##           .n.fit  err.abs.OOB.sum err.abs.OOB.mean 
##       248.000000        87.693992         2.114520
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0    teardown 52.417  NA      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 12 fit.models          6          2           2 44.722 52.426   7.704
## 13 fit.models          6          3           3 52.427     NA      NA
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.models_3-1.png) 
...
```
##                label step_major step_minor label_minor    bgn    end
## 13        fit.models          6          3           3 52.427 56.117
## 14 fit.data.training          7          0           0 56.117     NA
##    elapsed
## 13    3.69
## 14      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 14 fit.data.training          7          0           0 56.117 56.535
## 15 fit.data.training          7          1           1 56.536     NA
##    elapsed
## 14   0.418
## 15      NA
```
...
```
##             All.X##rcv#glm.imp imp Final.All.X##rcv#glm.imp
## BODY.WEIGHT                100 100                      100
## .rnorm                       0   0                        0
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.data.training_1-1.png) ![](DADHosp_SLR_rspvar_files/figure-html/fit.data.training_1-2.png) 

```
##     PTID BODY.WEIGHT HOSPITAL.COST  .src Hosp.Cost.log     .rnorm
## 13     7          60      887350.0 Train      13.69599 -0.4824486
## 3      2          41      809130.0 Train      13.60371  2.5252625
## 71    36           6      551809.0 Train      13.22096 -0.2444947
## 317  159          64       55885.7 Train      10.93106 -1.1767844
## 1      1          49      660293.0 Train      13.40044 -0.4801124
##     HospCost.cut.fctr .lcn Hosp.Cost.log.All.X..rcv.glm
## 13      (3e+05,9e+05]  OOB                           NA
## 3       (3e+05,9e+05]  OOB                           NA
## 71      (3e+05,9e+05]  OOB                           NA
## 317         [0,1e+05]  OOB                           NA
...
## 317                               NA                                   NA
## 1                                 NA                                   NA
##     Hosp.Cost.log.All.X..rcv.glm.is.acc Hosp.Cost.log.Final.All.X..rcv.glm
## 13                                   NA                           12.23836
## 3                                    NA                           12.16164
## 71                                   NA                           11.79259
## 317                                  NA                           12.25283
## 1                                    NA                           12.14629
##     Hosp.Cost.log.Final.All.X..rcv.glm.err
## 13                                1.457637
## 3                                 1.442071
## 71                                1.428370
## 317                               1.321769
## 1                                 1.254150
##     Hosp.Cost.log.Final.All.X..rcv.glm.err.abs
## 13                                    1.457637
## 3                                     1.442071
## 71                                    1.428370
## 317                                   1.321769
## 1                                     1.254150
##     Hosp.Cost.log.Final.All.X..rcv.glm.is.acc .label
## 13                                      FALSE      7
## 3                                       FALSE      2
## 71                                      FALSE     36
## 317                                     FALSE    159
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.data.training_1-3.png) 
...
```
## [1] "Hosp.Cost.log.Final.All.X..rcv.glm"        
## [2] "Hosp.Cost.log.Final.All.X..rcv.glm.err"    
## [3] "Hosp.Cost.log.Final.All.X..rcv.glm.err.abs"
## [4] "Hosp.Cost.log.Final.All.X..rcv.glm.is.acc"
```
...
![](DADHosp_SLR_rspvar_files/figure-html/fit.data.training_1-4.png) 
...
```
##                label step_major step_minor label_minor    bgn    end
## 15 fit.data.training          7          1           1 56.536 59.331
...
![](DADHosp_SLR_rspvar_files/figure-html/predict.data.new-1.png) ![](DADHosp_SLR_rspvar_files/figure-html/predict.data.new-2.png) 
...
## 318  159          64       55885.7 Test      10.93106 -0.4055507
## 2      1          49      660293.0 Test      13.40044  1.4350423
##     HospCost.cut.fctr .lcn Hosp.Cost.log.Final.All.X..rcv.glm
## 4       (3e+05,9e+05]  OOB                           12.11785
## 14      (3e+05,9e+05]  OOB                           12.21787
## 72      (3e+05,9e+05]  OOB                           11.79552
## 318         [0,1e+05]  OOB                           12.27397
## 2       (3e+05,9e+05]  OOB                           12.19877
##     Hosp.Cost.log.Final.All.X..rcv.glm.err
## 4                                 1.485865
## 14                                1.478124
## 72                                1.425438
...
![](DADHosp_SLR_rspvar_files/figure-html/predict.data.new-3.png) 
...
```
## [1] "glb_sel_mdl_id: All.X##rcv#glm"
```

```
## [1] "glb_fin_mdl_id: Final.All.X##rcv#glm"
```
...
## Max.cor.Y##rcv#rpart          0.4539678   0.18987739               NA
## Low.cor.X##rcv#glmnet         0.4662609   0.14540829       0.14471001
## All.X##rcv#glmnet             0.4662609   0.14540829       0.14471001
## Max.cor.Y.rcv.1X1###glmnet    0.4664706   0.14463921       0.14525410
## All.X##rcv#glm                0.4664914   0.14456320       0.14526677
## MFO###lm                      0.5073711  -0.01193403       0.00175475
##                            min.RMSE.fit
## Max.cor.Y##rcv#rpart          0.4797535
## Low.cor.X##rcv#glmnet         0.4676364
## All.X##rcv#glmnet             0.4676364
## Max.cor.Y.rcv.1X1###glmnet    0.4644112
## All.X##rcv#glm                0.4678318
## MFO###lm                      0.5029066
```

```
## [1] "All.X##rcv#glm OOB RMSE: 0.4665"
```
...
## [0,1e+05]         19     19     19     19        0.8468821
## (3e+05,9e+05]     34     34     34     34        0.7747157
## (2e+05,3e+05]     44     44     44     44        0.2726009
## (1e+05,2e+05]    151    151    151    151        0.2203209
##               err.abs.fit.mean err.abs.new.mean err.abs.trn.mean
## [0,1e+05]            0.8425207        0.8468821        0.8425207
## (3e+05,9e+05]        0.7706404        0.7747157        0.7706404
## (2e+05,3e+05]        0.2695075        0.2726009        0.2695075
## (1e+05,2e+05]        0.2194893        0.2203209        0.2194893
##               err.abs.OOB.sum err.abs.fit.sum err.abs.new.sum
## [0,1e+05]            16.09076        16.00789        16.09076
## (3e+05,9e+05]        26.34033        26.20177        26.34033
## (2e+05,3e+05]        11.99444        11.85833        11.99444
## (1e+05,2e+05]        33.26846        33.14288        33.26846
##               err.abs.trn.sum
## [0,1e+05]            16.00789
## (3e+05,9e+05]        26.20177
## (2e+05,3e+05]        11.85833
## (1e+05,2e+05]        33.14288
##   .freqRatio.Fit   .freqRatio.OOB   .freqRatio.Tst           .n.Fit 
##         1.000000         1.000000         1.000000       248.000000 
##           .n.OOB           .n.Tst           .n.fit           .n.new 
##       248.000000       248.000000       248.000000       248.000000 
##           .n.trn err.abs.OOB.mean err.abs.fit.mean err.abs.new.mean 
##       248.000000         2.114520         2.102158         2.114520 
## err.abs.trn.mean  err.abs.OOB.sum  err.abs.fit.sum  err.abs.new.sum 
##         2.102158        87.693992        87.210877        87.693992 
##  err.abs.trn.sum 
##        87.210877
```

```
## [1] "Final.All.X##rcv#glm prediction stats for glbObsNew:"
##               id max.R.sq.new min.RMSE.new max.Adj.R.sq.new
## 1 All.X##rcv#glm    0.1445632    0.4664914          0.13758
```

```
##             All.X__rcv_glm.imp Final.All.X__rcv_glm.imp
## BODY.WEIGHT                100                      100
```
...
![](DADHosp_SLR_rspvar_files/figure-html/predict.data.new-4.png) 

```
##                   label step_major step_minor label_minor    bgn    end
## 16     predict.data.new          8          0           0 59.332 67.119
## 17 display.session.info          9          0           0 67.120     NA
##    elapsed
## 16   7.788
## 17      NA
```
...
```
##                      label step_major step_minor label_minor    bgn    end
## 10              fit.models          6          0           0 27.583 37.786
## 16        predict.data.new          8          0           0 59.332 67.119
## 12              fit.models          6          2           2 44.722 52.426
## 2             inspect.data          2          0           0 13.586 21.195
## 11              fit.models          6          1           1 37.786 44.722
## 1              import.data          1          0           0  9.238 13.585
## 13              fit.models          6          3           3 52.427 56.117
## 3               scrub.data          2          1           1 21.196 24.099
## 15       fit.data.training          7          1           1 56.536 59.331
## 9          select.features          5          0           0 26.096 27.583
## 5         extract.features          3          0           0 24.145 25.468
## 6      manage.missing.data          3          1           1 25.469 25.909
## 14       fit.data.training          7          0           0 56.117 56.535
## 8  partition.data.training          4          0           0 25.952 26.095
## 4           transform.data          2          2           2 24.099 24.145
## 7             cluster.data          3          2           2 25.910 25.952
##    elapsed duration
## 10  10.203   10.203
## 16   7.788    7.787
...
## 4    0.046    0.046
## 7    0.042    0.042
## [1] "Total Elapsed Time: 67.119 secs"
```

![](DADHosp_SLR_rspvar_files/figure-html/display.session.info-1.png) 
...
##      bgn    end elapsed duration
## 3 29.988 34.703   4.715    4.715
## 4 34.703 37.776   3.073    3.073
## 2 28.080 29.988   1.908    1.908
## 1 28.047 28.080   0.033    0.033
## [1] "Total Elapsed Time: 37.776 secs"
```

![](DADHosp_SLR_rspvar_files/figure-html/display.session.info-2.png) 
